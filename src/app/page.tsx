          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-extrabold text-gray-900 mb-6 tracking-tight">
                Scale Your Social Media with <br />
            ...
            >
              Never run out of content ideas again. Get daily viral hooks, captions, and visual concepts tailored to your niche.
            </motion.p>
        ...
        <section className="py-20 px-4 bg-white">
          <div className="max-w-7xl mx-auto">
            <motion.div 
              ...
              variants={fadeInUp}
            >
              <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">Stop Staring at a Blank Screen</h2>
              <p className="text-xl text-gray-600">The biggest challenge for creators is consistency. We solved it.</p>
            </motion.div>
            ...
            >
              <motion.div variants={fadeInUp} className="p-8 rounded-2xl bg-gray-50 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold mb-4">Daily Viral Ideas</h3>
                <p className="text-gray-600">Fresh content concepts delivered every 24 hours to keep your feed active and engaging.</p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="p-8 rounded-2xl bg-gray-50 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold mb-4">High-Impact Hooks</h3>
                <p className="text-gray-600">Stop the scroll with battle-tested hooks designed to boost your retention and reach.</p>
              </motion.div>
              ...
              <motion.div variants={fadeInUp} className="p-8 rounded-2xl bg-gray-50 border border-gray-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                ...
                <h3 className="text-xl font-bold mb-4">Niche Specific</h3>
                <p className="text-gray-600">Tailored content for Fitness, Fashion, Business, Tech, and more. Relevant ideas only.</p>
              </motion.div>
            </motion.div>
          </div>
        </section>
